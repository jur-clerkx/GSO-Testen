...
public interface ITimeSpan2 {
     ...
     * otherwise false
     */
    boolean isPartOf(ITimeSpan2 timeSpan);
     ...
     */
    ITimeSpan2 unionWith(ITimeSpan2 timeSpan);
     ...
     * be returned
     */
    ITimeSpan2 intersectionWith(ITimeSpan2 timeSpan);
}
